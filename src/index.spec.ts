...
import { formatToBrazilianDate, isBrazilianBusinessDay } from "./index"
import { format } from "date-fns"

describe("É dia útil?", function () {
  it("Dado uma data inválida, o resultado esperado é false", function () {
    expect(isBrazilianBusinessDay("8787-52-67" as any)).to.equal(false)
  })
})
...
describe("É dia útil? (Não considerando o estado)", function () {
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        format(new Date(test.givenDate), "yyyy-MM-dd") +
        " (que é " +
        test.description +
        "), o resultado esperado é " +
        test.expectedResult,
      () => {
        expect(isBrazilianBusinessDay(new Date(test.givenDate))).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado do Acre?", function () {
  var tests = [
    {
      givenDate: "2000-01-23",
      description: "Dia do evangélico - Lei Estadual nº 1.538/2004",
      expectedResult: false,
    },
    {
      givenDate: "2000-03-08",
      description:
        "Alusivo ao Dia Internacional da Mulher - Lei Estadual nº 1.411/2001",
      expectedResult: false,
    },
    {
      givenDate: "2000-06-15",
      description: "Aniversário do estado - Lei Estadual nº 14/1964",
      expectedResult: false,
    },
    {
      givenDate: "2000-09-05",
      description: "Dia da Amazônia - Lei Estadual nº 1.526/2004",
      expectedResult: false,
    },
    {
      givenDate: "2000-11-17",
      description:
        "Assinatura do Tratado de Petrópolis - Lei estadual nº 57/1965",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      () => {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "AC")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Santa Catarina?", function () {
  var tests = [
    {
      givenDate: "2019-08-11",
      description:
        "Dia de Santa Catarina (criação da capitania, separando-se de São Paulo)",
      expectedResult: false,
    },
    {
      givenDate: "2020-08-11",
      description:
        "Dia de Santa Catarina (criação da capitania, separando-se de São Paulo)",
      expectedResult: false,
    },
    {
      givenDate: "2021-08-11",
      description:
        "Dia de Santa Catarina (criação da capitania, separando-se de São Paulo)",
      expectedResult: false,
    },
    {
      givenDate: "2015-11-25",
      description: "Dia de Santa Catarina de Alexandria",
      expectedResult: false,
    },
    {
      givenDate: "2016-11-25",
      description: "Dia de Santa Catarina de Alexandria",
      expectedResult: false,
    },
    {
      givenDate: "2017-11-25",
      description: "Dia de Santa Catarina de Alexandria",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "SC")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de São Paulo?", function () {
  var tests = [
    {
      givenDate: "2000-07-09",
      description:
        "Revolução Constitucionalista de 1932 - Lei estadual nº 9.497/1997",
      expectedResult: false,
    },
    {
      givenDate: "2013-07-09",
      description:
        "Revolução Constitucionalista de 1932 - Lei estadual nº 9.497/1997",
      expectedResult: false,
    },
    {
      givenDate: "2018-07-09",
      description:
        "Revolução Constitucionalista de 1932 - Lei estadual nº 9.497/1997",
      expectedResult: false,
    },
    {
      givenDate: "2025-07-09",
      description:
        "Revolução Constitucionalista de 1932 - Lei estadual nº 9.497/1997",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "SP")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Sergipe?", function () {
  var tests = [
    {
      givenDate: "2000-07-08",
      description:
        "Emancipação política de Sergipe - Art. 269 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2012-07-08",
      description:
        "Emancipação política de Sergipe - Art. 269 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2019-07-08",
      description:
        "Emancipação política de Sergipe - Art. 269 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2022-07-08",
      description:
        "Emancipação política de Sergipe - Art. 269 da Constituição estadual",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "SE")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Tocantins?", function () {
  var tests = [
    {
      givenDate: "2001-10-05",
      description: "Criação do estado - Lei estadual nº 98/1989",
      expectedResult: false,
    },
    {
      givenDate: "2040-10-05",
      description: "Criação do estado - Lei estadual nº 98/1989",
      expectedResult: false,
    },
    {
      givenDate: "2045-10-05",
      description: "Criação do estado - Lei estadual nº 98/1989",
      expectedResult: false,
    },
    {
      givenDate: "2004-10-05",
      description: "Criação do estado - Lei estadual nº 98/1989",
      expectedResult: false,
    },
    {
      givenDate: "2005-10-05",
      description: "Criação do estado - Lei estadual nº 98/1989",
      expectedResult: false,
    },
    {
      givenDate: "2016-03-18",
      description:
        "Autonomia do Estado (criação da Comarca do Norte) - Lei estadual nº 960/1998",
      expectedResult: false,
    },
    {
      givenDate: "2027-03-18",
      description:
        "Autonomia do Estado (criação da Comarca do Norte) - Lei estadual nº 960/1998",
      expectedResult: false,
    },
    {
      givenDate: "2008-03-18",
      description:
        "Autonomia do Estado (criação da Comarca do Norte) - Lei estadual nº 960/1998",
      expectedResult: false,
    },
    {
      givenDate: "2009-03-18",
      description:
        "Autonomia do Estado (criação da Comarca do Norte) - Lei estadual nº 960/1998",
      expectedResult: false,
    },
    {
      givenDate: "2010-03-18",
      description:
        "Autonomia do Estado (criação da Comarca do Norte) - Lei estadual nº 960/1998",
      expectedResult: false,
    },
    {
      givenDate: "2011-09-08",
      description:
        "Padroeira do Estado (Nossa Senhora da Natividade) - Lei estadual nº 627/1993",
      expectedResult: false,
    },
    {
      givenDate: "2028-09-08",
      description:
        "Padroeira do Estado (Nossa Senhora da Natividade) - Lei estadual nº 627/1993",
      expectedResult: false,
    },
    {
      givenDate: "2020-09-08",
      description:
        "Padroeira do Estado (Nossa Senhora da Natividade) - Lei estadual nº 627/1993",
      expectedResult: false,
    },
    {
      givenDate: "2014-09-08",
      description:
        "Padroeira do Estado (Nossa Senhora da Natividade) - Lei estadual nº 627/1993",
      expectedResult: false,
    },
    {
      givenDate: "2015-09-08",
      description:
        "Padroeira do Estado (Nossa Senhora da Natividade) - Lei estadual nº 627/1993",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "TO")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Roraima?", function () {
  var tests = [
    {
      givenDate: "1988-10-05",
      description: "Criação do estado - Art. 9 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "1995-10-05",
      description: "Criação do estado - Art. 9 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2000-10-05",
      description: "Criação do estado - Art. 9 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2007-10-05",
      description: "Criação do estado - Art. 9 da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2019-10-05",
      description: "Criação do estado - Art. 9 da Constituição estadual",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "RR")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Rondônia?", function () {
  var tests = [
    ...
    {
      givenDate: "2020-01-04",
      description: "Criação do estado - Lei estadual nº 2291/2010",
      expectedResult: false,
    },
    {
      givenDate: "2021-01-04",
      description: "Criação do estado - Lei estadual nº 2291/2010",
      expectedResult: false,
    },
    {
      givenDate: "2022-01-04",
      description: "Criação do estado - Lei estadual nº 2291/2010",
      expectedResult: false,
    },
    {
      givenDate: "2023-01-04",
      description: "Criação do estado - Lei estadual nº 2291/2010",
      expectedResult: false,
    },
    {
      givenDate: "2025-06-18",
      description: "Dia do evangélico - Lei estadual nº 1.026/2001",
      expectedResult: false,
    },
    {
      givenDate: "2026-06-18",
      description: "Dia do evangélico - Lei estadual nº 1.026/2001",
      expectedResult: false,
    },
    {
      givenDate: "2027-06-18",
      description: "Dia do evangélico - Lei estadual nº 1.026/2001",
      expectedResult: false,
    },
    {
      givenDate: "2028-06-18",
      description: "Dia do evangélico - Lei estadual nº 1.026/2001",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "RO")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "RS")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "RN")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Piauí?", function () {
  var tests = [
    {
      givenDate: "2000-10-19",
      description: "Dia do Piauí - Lei estadual nº 176/1937",
      expectedResult: false,
    },
    {
      givenDate: "2002-10-19",
      description: "Dia do Piauí - Lei estadual nº 176/1937",
      expectedResult: false,
    },
    {
      givenDate: "2008-10-19",
      description: "Dia do Piauí - Lei estadual nº 176/1937",
      expectedResult: false,
    },
    {
      givenDate: "2019-10-19",
      description: "Dia do Piauí - Lei estadual nº 176/1937",
      expectedResult: false,
    },
    {
      givenDate: "2024-10-19",
      description: "Dia do Piauí - Lei estadual nº 176/1937",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "PI")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "PE")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Paraná?", function () {
  var tests = [
    {
      givenDate: "1997-12-19",
      description:
        "Emancipação política do estado do Paraná - Lei estadual nº 4.658/1962",
      expectedResult: false,
    },
    {
      givenDate: "2005-12-19",
      description:
        "Emancipação política do estado do Paraná - Lei estadual nº 4.658/1962",
      expectedResult: false,
    },
    {
      givenDate: "2019-12-19",
      description:
        "Emancipação política do estado do Paraná - Lei estadual nº 4.658/1962",
      expectedResult: false,
    },
    {
      givenDate: "2035-12-19",
      description:
        "Emancipação política do estado do Paraná - Lei estadual nº 4.658/1962",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "PR")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "PB")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Pará?", function () {
  var tests = [
    {
      givenDate: "1996-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
    {
      givenDate: "2000-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
    {
      givenDate: "2001-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
    {
      givenDate: "2016-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
    {
      givenDate: "2022-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
    {
      givenDate: "2027-08-15",
      description:
        "Adesão do Pará à independência do Brasil - Lei estadual nº 5.999/1996",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "PA")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "MG")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Mato Grosso do Sul?", function () {
  var tests = [
    ...
    {
      givenDate: "2020-10-11",
      description: "Criação do estado - Lei estadual nº 10/1979",
      expectedResult: false,
    },
    {
      givenDate: "2022-10-11",
      description: "Criação do estado - Lei estadual nº 10/1979",
      expectedResult: false,
    },
    {
      givenDate: "2027-10-11",
      description: "Criação do estado - Lei estadual nº 10/1979",
      expectedResult: false,
    },
    {
      givenDate: "2034-10-11",
      description: "Criação do estado - Lei estadual nº 10/1979",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "MS")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "MT")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Maranhão?", function () {
  var tests = [
    {
      givenDate: "2019-07-28",
      description:
        "Adesão do Maranhão à independência do Brasil - Lei estadual nº 2.457/1964",
      expectedResult: false,
    },
    {
      givenDate: "2020-07-28",
      description:
        "Adesão do Maranhão à independência do Brasil - Lei estadual nº 2.457/1964",
      expectedResult: false,
    },
    {
      givenDate: "2021-07-28",
      description:
        "Adesão do Maranhão à independência do Brasil - Lei estadual nº 2.457/1964",
      expectedResult: false,
    },
    {
      givenDate: "2022-07-28",
      description:
        "Adesão do Maranhão à independência do Brasil - Lei estadual nº 2.457/1964",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "MA")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado de Alagoas?", function () {
  var tests = [
    ...
    {
      givenDate: "2020-06-24",
      description: "São João - Lei estadual nº 5.508/1993",
      expectedResult: false,
    },
    {
      givenDate: "2021-06-24",
      description: "São João - Lei estadual nº 5.508/1993",
      expectedResult: false,
    },
    {
      givenDate: "2022-06-29",
      description: "São Pedro - Lei estadual nº 5.509/1993",
      expectedResult: false,
    },
    {
      givenDate: "2023-06-29",
      description: "São Pedro - Lei estadual nº 5.509/1993",
      expectedResult: false,
    },
    {
      givenDate: "2024-06-29",
      description: "São Pedro - Lei estadual nº 5.509/1993",
      expectedResult: false,
    },
    {
      givenDate: "2025-09-16",
      description: "Emancipação política",
      expectedResult: false,
    },
    {
      givenDate: "2026-09-16",
      description: "Emancipação política",
      expectedResult: false,
    },
    {
      givenDate: "2027-09-16",
      description: "Emancipação política",
      expectedResult: false,
    },
    {
      givenDate: "2028-11-20",
      description: "Morte de Zumbi dos Palmares - Lei estadual nº 5.724/1995",
      expectedResult: false,
    },
    {
      givenDate: "2029-11-20",
      description: "Morte de Zumbi dos Palmares - Lei estadual nº 5.724/1995",
      expectedResult: false,
    },
    {
      givenDate: "2030-11-20",
      description: "Morte de Zumbi dos Palmares - Lei estadual nº 5.724/1995",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "AL")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado do Distrito Federal?", function () {
  var tests = [
    ...
    {
      givenDate: "2019-11-30",
      description: "Dia do evangélico - Lei distrital nº 963/1995",
      expectedResult: false,
    },
    {
      givenDate: "2020-11-30",
      description: "Dia do evangélico - Lei distrital nº 963/1995",
      expectedResult: false,
    },
    {
      givenDate: "2021-11-30",
      description: "Dia do evangélico - Lei distrital nº 963/1995",
      expectedResult: false,
    },
    {
      givenDate: "2022-11-30",
      description: "Dia do evangélico - Lei distrital nº 963/1995",
      expectedResult: false,
    },
  ]
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "DF")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado do Ceará?", function () {
  var tests = [
    {
      givenDate: "2019-03-19",
      description:
        "Dia de São José (Padroeiro do Ceará) - Lei Federal nº 9.093/1995",
      expectedResult: false,
    },
    {
      givenDate: "2019-03-25",
      description:
        "Data magna do estado (data da abolição da escravidão no Ceará) - Art. 18, parágrafo único da constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2019-08-15",
      description:
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "CE")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("É dia útil no estado da Bahia?", function () {
  var tests = [
    {
      givenDate: "2002-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2003-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2010-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2015-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2020-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2025-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
    {
      givenDate: "2030-07-02",
      description:
        "Independência da Bahia (Data magna do estado) - Art. 6º, § 3º da Constituição estadual",
      expectedResult: false,
    },
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "BA")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "AM")).to.equal(
          test.expectedResult,
        )
      },
    )
  ...
  var tests = [
    {
      givenDate: "2019-03-19",
      description:
        "Dia de São José, santo padroeiro do Estado do Amapá - Lei estadual nº 667, de 16 de abril de 2002",
      expectedResult: false,
    },
    {
      givenDate: "2019-09-13",
      description:
  ...
  tests.forEach(function (test) {
    it(
      "Dado dia " +
        ...
        test.expectedResult,
      function () {
        expect(isBrazilianBusinessDay(new Date(test.givenDate), "AP")).to.equal(
          test.expectedResult,
        )
      },
    )
...
describe("Formatar data", function () {
  const date = new Date("2020-01-01")

  it("Formato para data brasileira", function () {
    expect(formatToBrazilianDate(date)).to.equal("01/01/2020")
  })

  it("Não quebra quando a data é inválida", function () {
    expect(formatToBrazilianDate("2020-01-01" as any)).to.equal("")
  })
})
